...
"""Backend-to-backend calls to the SSO API.

Used for:
- live role lookup (GET /auth/me)
- cookie proxy refresh / logout

Normal request auth stays local JWT verify — never call SSO for that.
"""
