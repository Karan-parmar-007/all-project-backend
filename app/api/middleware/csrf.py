...
_EXEMPT_PREFIXES = (
    "/health",
    "/api/allprojects/health",
    "/api/allprojects/portfolio",
    "/api/allprojects/auth/session",
    "/api/auth/session",
    # Match SSO: refresh must work even when the access cookie is stale.
    "/api/allprojects/auth/refresh",
    "/api/auth/refresh",
    "/docs",
    "/redoc",
    "/openapi.json",
...
class CSRFMiddleware(BaseHTTPMiddleware):
    """Double-submit CSRF. This app never sets the cookie — the SSO does."""
